...
module.exports = (router: any) => {
  ...
  router.get(`${BASE_URL}/:show_id/sold_items/:item_id`, tryCatchWrapper(ShowController.getOneItemSoldPerShow)),
  router.get(`${BASE_URL}/:show_id/sold_items`, tryCatchWrapper(ShowController.getAllItemSoldPerShow)),
